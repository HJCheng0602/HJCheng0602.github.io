...
export const theme: ThemeUserConfig = {
  ...
  footer: {
    ...
    social: { github: 'https://github.com/HJCheng0602' }
  },
...
export const integ: IntegrationUserConfig = {
  ...
  waline: {
    enable: true,
    // Server service link
    server: 'https://miaomiao-nagqxo5e0-hjcheng0602s-projects.vercel.app/',
